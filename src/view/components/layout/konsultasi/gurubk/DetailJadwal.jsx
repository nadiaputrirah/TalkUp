...
const DetailJadwalKonseling = ({ data }) => {
  ...
  const fields = [
    ...
    },
    {
      ...
      icon: <LinkOutlined />,
      onClick: data.jenisSesi === "Online" ? handleLinkClick : undefined,
      className: data.jenisSesi === "Online" 
...
export default DetailJadwalKonseling;